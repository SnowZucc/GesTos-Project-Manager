...
public class VoirTachesFX {
    ...
    private void creerTache(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/louisjulien/gestos/Taches/creerTache.fxml"));
    ...
    private void modifierTache(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/louisjulien/gestos/Taches/modifierTache.fxml"));
            Scene scene = new Scene(loader.load());
    ...
    private void vueKanban(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/louisjulien/gestos/Taches/vueKanban.fxml"));
            Scene scene = new Scene(loader.load());
