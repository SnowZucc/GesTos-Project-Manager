...
import louisjulien.gestos.Controlleurs.Taches.VoirTachesFX;
...
public class ProjetsFX {
    ...
    private void creerProjet(ActionEvent event) {
        changerScene(event, "/louisjulien/gestos/Projets/creerProjet.fxml");
    }
    ...
    private void modifierProjet(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/louisjulien/gestos/Projets/modifierProjet.fxml"));
...
//          Projet.getListeProjets().remove(projetSelectionne);
    ...
    private void voirTaches(ActionEvent event) {
        Projet projetSelectionne = tableProjets.getSelectionModel().getSelectedItem();
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/louisjulien/gestos/Taches/voirTaches.fxml"));
                Scene scene = new Scene(loader.load());
